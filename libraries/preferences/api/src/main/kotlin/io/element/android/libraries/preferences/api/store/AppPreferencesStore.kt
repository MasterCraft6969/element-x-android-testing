...
interface AppPreferencesStore {
    ...
    suspend fun setConnectionLightSettings(primaryColorArgb: Int, secondaryColorArgb: Int, gradientEnabled: Boolean)
    fun getConnectionLightPrimaryColorFlow(): Flow<Int>
    fun getConnectionLightSecondaryColorFlow(): Flow<Int>
    fun isConnectionLightGradientEnabledFlow(): Flow<Boolean>
