    ...
    override fun present(): AdvancedSettingsState {
        ...
        fun handleEvent(event: AdvancedSettingsEvents) {
            when (event) {
                ...
                is AdvancedSettingsEvents.SetConnectionLightSettings -> sessionCoroutineScope.launch {
                    appPreferencesStore.setConnectionLightSettings(
                        primaryColorArgb = event.primaryColorArgb,
                        secondaryColorArgb = event.secondaryColorArgb,
                        gradientEnabled = event.gradientEnabled,
                    )
                }
        ...
        return AdvancedSettingsState(
            ...
            connectionLightSettings = ConnectionLightSettings(
                primaryColorArgb = connectionLightPrimaryColor,
                secondaryColorArgb = connectionLightSecondaryColor,
