...
internal fun aHomeState(
    ...
    connectionLightPrimaryColorArgb: Int = 0xFFA8D8FF.toInt(),
    connectionLightSecondaryColorArgb: Int = 0xFFF0F4FF.toInt(),
    ...
    syncState = syncState,
    connectionLightPrimaryColorArgb = connectionLightPrimaryColorArgb,
    connectionLightSecondaryColorArgb = connectionLightSecondaryColorArgb,
    connectionLightGradientEnabled = connectionLightGradientEnabled,
